...
def plot(df_master, units):
    ...
    if df_master.domain == 'freq':
        ...
        df_master.plot(x='f', y=[stor],color='r',marker='o',markevery=10,linewidth=0.5, ax=ax1, logx=True, logy=True)
        df_master.plot(x='f', y=[loss],color='darkred',marker='o',markevery=10, ax=ax2, logx=True, logy=True)
        fig.show()
        return fig
